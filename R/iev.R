...
#' expected value of X is E(X)=∑nk=1k×Pr(X=k). The expected value offers
#' us a way of taking the long-term average of a random variable over a
...
#' value b, then E(X)=a+b2. You may also wish to verify that for the
#' dice example, if Y is the random variable associated with the outcome
#' of a second die roll, then E(X+Y)=7.
#' 
